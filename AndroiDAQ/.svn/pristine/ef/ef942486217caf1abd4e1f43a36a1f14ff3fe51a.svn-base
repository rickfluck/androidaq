...
//public class AndroiDAQAdapter extends PagerAdapter implements ScrollViewListener {
 ...
 // get digital states for each digital output
    ...
    public ArrayList<String> getDesiredDuty(ArrayList<String> isOutputPulsed) {
    	...
    	for (int i = 0; i < index; i++) {
    		...
    		//Log.e("Test", "Channel is: " + chNumber);
    		//Log.e("Test", "outputStateChs is: " + desiredFreq[chNumber]);
    		dutyChs.add(String.valueOf(desiredDuty[chNumber]));
	...
	public void setProp() {
    	...
    	if (runContInputs) {
    		((AndroiDAQMain) context).getInputsCont(true);
	...
	public void stopContInput() {
		((AndroiDAQMain) context).stopContInput();
	}
    @Override
    ...
    public Bundle getUIStates() {
    	...
    	boolean[] isDig = {
     	...
     	for (String duty: desiredDuty) {
    		Log.e("test", "saving these freqs:" + duty);
    	}
    	Bundle myBundle = new Bundle();
